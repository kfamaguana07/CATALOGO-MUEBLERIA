              ...
              <ul className="footer-menu">
                <li>
                  <Link to="/" className="footer-link">
                    <span className="link-icon">›</span> Inicio
                  </Link>
                </li>
                <li>
                  <Link to="/diseños" className="footer-link">
                    <span className="link-icon">›</span> Diseños
                  </Link>
                </li>
                <li>
                  <Link to="/contactos" className="footer-link">
                    <span className="link-icon">›</span> Contactos
                  </Link>
                </li>
                <li>
                  <Link to="/trabajos-realizados" className="footer-link">
                    <span className="link-icon">›</span> Trabajos Realizados
                  </Link>
                </li>
              </ul>
            </div>
